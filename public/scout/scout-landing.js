/* Compiled from scout-landing.jsx by @babel/preset-react. Do not edit directly; edit the .jsx and re-run scripts/build_scout_report.js. */
(function () {
/* global React */
...
const L_LOCS = SL.LOCATIONS.flatMap(l => l.cities.map(c => ({
  label: c + ", " + l.country,
  city: c,
  country: l.country
})));
...
const L_ICONS = {
  trend: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    d: "M3 17l5.5-6.5 4 3.5L19 6"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M14.5 6H19v4.5"
  })),
  book: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    d: "M12 6c-2.2-1.6-5.3-1.6-8 0v12.5c2.7-1.6 5.8-1.6 8 0 2.2-1.6 5.3-1.6 8 0V6c-2.7-1.6-5.8-1.6-8 0z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M12 6v12.5"
  })),
  ...
  mega: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    d: "M3.5 11l13.5-6v14l-13.5-6v-2z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M7.5 13.8V17a2.2 2.2 0 004.4 0v-1.4"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M20 9.5a4 4 0 010 5"
  })),
  person: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
    ...
    d: "M5 19.5c1.5-3.6 4-5.2 7-5.2s5.5 1.6 7 5.2"
  })),
  pin: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    d: "M12 21.5S5 15 5 10a7 7 0 0114 0c0 5-7 11.5-7 11.5z"
  ...
  layers: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    d: "M12 3.5l8.5 4.7L12 12.9 3.5 8.2 12 3.5z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M3.5 13l8.5 4.7L20.5 13"
  })),
  plug: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    d: "M9 7.5V3.5M15 7.5V3.5"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M7 7.5h10v3.5a5 5 0 01-10 0V7.5z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M12 16v4.5"
  })),
  ...
  db: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("ellipse", {
    ...
    d: "M5 5.5V18c0 1.45 3.1 2.6 7 2.6s7-1.15 7-2.6V5.5"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M5 11.8c0 1.45 3.1 2.6 7 2.6s7-1.15 7-2.6"
  })),
  git: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("circle", {
    ...
    d: "M6 8.5v7M16 10.5c-3 1.5-7 .5-9 4"
  }))
};
...
const L_MAP = ["................................................", "........#######..####............#####..........", "......##########.#####....#####################.", "..##############.####.#..######################.", "..###.##########.......#.######################.", ".......########........########################.", ".......########.........###################.....", "........######........#####################.....", ".........###.........#####################......", "..........###........###################........", "...........###.......###########.##..##.........", ".............#####.....########......######.....", ".............######.....#######.......#######...", "..............#####......######.........####....", "..............####.......#####.#.......######...", "...............###........####.........######...", "...............##.........###............####...", "...............##.............................#.", "...............##............................##.", "...............##...............................", "................................................", "................................................", "................................................", "................................................"].map(r => (r + "................................................").slice(0, 48));
...
function LGlobe() {
  ...
  uEL(() => {
    ...
    const draw = t => {
      ...
      const pv = (v, m) => {
        const s = m || 1;
        const y = v[1] * ct - v[2] * st,
          z = v[1] * st + v[2] * ct;
        return [cx + v[0] * R * s, cy - y * R * s, z];
      };
      // atmosphere halo
      let g = ctx.createRadialGradient(cx, cy, R * 0.82, cx, cy, R * 1.28);
      g.addColorStop(0, "rgba(34,200,120,0)");
      g.addColorStop(0.5, "rgba(34,200,120,.15)");
      g.addColorStop(1, "rgba(34,200,120,0)");
      ctx.fillStyle = g;
      ctx.beginPath();
      ...
      g.addColorStop(0, "#104228");
      g.addColorStop(0.55, "#072717");
      g.addColorStop(1, "#031a10");
      ctx.fillStyle = g;
      ctx.beginPath();
      ctx.arc(cx, cy, R, 0, 7);
      ctx.fill();
      ctx.strokeStyle = "rgba(83,243,157,.22)";
      ctx.lineWidth = 1;
      ctx.beginPath();
      ctx.arc(cx, cy, R, 0, 7);
      ctx.stroke();
      ...
      for (let i = 0; i < L_ARCS.length; i++) {
        ...
        ctx.strokeStyle = "rgba(83,243,157,.4)";
        ctx.lineWidth = 1.1;
        ctx.stroke();
        ...
        if (sp[2] > 0) {
          ...
          g3.addColorStop(0, "rgba(125,255,181,.95)");
          g3.addColorStop(1, "rgba(125,255,181,0)");
          ctx.fillStyle = g3;
          ctx.beginPath();
          ctx.arc(sp[0], sp[1], 6, 0, 7);
          ctx.fill();
        }
      }
      // city nodes (pulsing)
      for (let i = 0; i < cities.length; i++) {
        ...
        g4.addColorStop(0, "rgba(83,243,157,.75)");
        g4.addColorStop(1, "rgba(83,243,157,0)");
        ctx.fillStyle = g4;
        ctx.beginPath();
        ctx.arc(sx, sy, 11 * pulse, 0, 7);
        ctx.fill();
        ctx.fillStyle = "#7dffb5";
        ctx.beginPath();
        ctx.arc(sx, sy, 2.2, 0, 7);
        ctx.fill();
      }
...
const L_SLIDES = [{
  ...
  render: () => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "lc-trend t1"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lc-ic"
  }, /*#__PURE__*/React.createElement(LIc, {
    d: L_ICONS.zap,
    size: 17
  })), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("b", null, "AI Agents"), /*#__PURE__*/React.createElement("i", null, "+142%"))), /*#__PURE__*/React.createElement("div", {
    className: "lc-trend t2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lc-ic"
  }, /*#__PURE__*/React.createElement(LIc, {
    d: L_ICONS.layers,
    size: 17
  })), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("b", null, "RAG Systems"), /*#__PURE__*/React.createElement("i", null, "+87%"))), /*#__PURE__*/React.createElement("div", {
    className: "lc-trend t3"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lc-ic"
  }, /*#__PURE__*/React.createElement(LIc, {
    d: L_ICONS.plug,
    size: 17
  })), /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("b", null, "MCP Tools"), /*#__PURE__*/React.createElement("i", null, "+113%"))))
}, {
  ...
  render: () => /*#__PURE__*/React.createElement("div", {
    ...
    className: "n"
  }, "#1"), /*#__PURE__*/React.createElement("b", null, "AI Agents"), /*#__PURE__*/React.createElement("span", {
    className: "pct"
  }, "+142%")), /*#__PURE__*/React.createElement("div", {
    className: "lc-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "n"
  }, "#2"), /*#__PURE__*/React.createElement("b", null, "MCP Tools"), /*#__PURE__*/React.createElement("span", {
    className: "pct"
  }, "+113%")), /*#__PURE__*/React.createElement("div", {
    className: "lc-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "n"
  }, "#3"), /*#__PURE__*/React.createElement("b", null, "RAG Systems"), /*#__PURE__*/React.createElement("span", {
    className: "pct"
  }, "+87%")))
}, {
  ...
  render: () => /*#__PURE__*/React.createElement("div", {
    ...
    className: "lc-bptitle"
  }, "Local Trend Scout"), /*#__PURE__*/React.createElement("div", {
    className: "lc-kv"
  }, /*#__PURE__*/React.createElement("span", {
    className: "k"
  ...
  render: () => /*#__PURE__*/React.createElement("div", {
    className: "lc-center"
  }, ["GitHub repo", "Blog post", "LinkedIn update", "Live demo"].map(t => /*#__PURE__*/React.createElement("div", {
    className: "lc-row",
    key: t
  }, /*#__PURE__*/React.createElement("span", {
    className: "ck"
...
function LCarousel() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "lc l-an d3" + (idx !== 0 ? " dim" : ""),
  ...
  }, /*#__PURE__*/React.createElement(LGlobe, null), /*#__PURE__*/React.createElement("div", {
    className: "lc-top"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lc-count"
  }, idx + 1, " / ", N), /*#__PURE__*/React.createElement("span", {
    className: "lc-arrows"
    ...
    className: "lc-slide",
    key: idx
  }, L_SLIDES[idx].render(), /*#__PURE__*/React.createElement("div", {
    className: "lc-title"
  }, L_SLIDES[idx].title))), /*#__PURE__*/React.createElement("div", {
    className: "lc-dots"
  }, L_SLIDES.map((_, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    className: i === idx ? "on" : "",
    onClick: () => setIdx(i),
...
function Landing({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "l-wrap l-hero-grid"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    className: "l-eyebrow l-an"
  }, /*#__PURE__*/React.createElement("span", {
    className: "dot"
    ...
    value: locLabel,
    onChange: e => {
      const o = L_LOCS.find(x => x.label === e.target.value);
      if (o) setLocation(o.city, o.country);
    },
    options: L_LOCS.map(o => ({
      value: o.label,
      label: o.label
    }))
  }), /*#__PURE__*/React.createElement(LField, {
    ...
    className: "n"
  }, "1"), "Choose your profile"), /*#__PURE__*/React.createElement("div", {
    className: "hiw-d"
  }, "Tell us who you are and what you do."))), /*#__PURE__*/React.createElement("span", {
    className: "hiw-line"
  }), /*#__PURE__*/React.createElement("div", {
    className: "hiw-item"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "n"
  }, "2"), "Pick your location"), /*#__PURE__*/React.createElement("div", {
    className: "hiw-d"
  }, "We analyze your local tech ecosystem."))), /*#__PURE__*/React.createElement("span", {
    className: "hiw-line"
  }), /*#__PURE__*/React.createElement("div", {
    className: "hiw-item"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "n"
  }, "3"), "Get your next move"), /*#__PURE__*/React.createElement("div", {
    className: "hiw-d"
  }, "Receive a data-driven plan you can act on today."))))), /*#__PURE__*/React.createElement("section", {
    className: "l-sec tight"
  }, /*#__PURE__*/React.createElement("span", {
    className: "l-kicker"
    ...
    className: "wyg-t"
  }, "Trending topics"), /*#__PURE__*/React.createElement("div", {
    className: "wyg-d"
  }, "Top technologies rising locally and globally."))), /*#__PURE__*/React.createElement("div", {
    className: "wyg-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "wyg-ic"
  }, /*#__PURE__*/React.createElement(LIc, {
    ...
    className: "wyg-t"
  }, "Study paths"), /*#__PURE__*/React.createElement("div", {
    className: "wyg-d"
  }, "Personalized learning plans with resources."))), /*#__PURE__*/React.createElement("div", {
    className: "wyg-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "wyg-ic"
  }, /*#__PURE__*/React.createElement(LIc, {
    ...
    className: "wyg-t"
  }, "Project blueprints"), /*#__PURE__*/React.createElement("div", {
    className: "wyg-d"
  }, "Portfolio-ready ideas with tech stacks."))), /*#__PURE__*/React.createElement("div", {
    className: "wyg-card"
  }, /*#__PURE__*/React.createElement("span", {
    className: "wyg-ic"
  }, /*#__PURE__*/React.createElement(LIc, {
    ...
    className: "wyg-t"
  }, "Visibility plans"), /*#__PURE__*/React.createElement("div", {
    className: "wyg-d"
  }, "Step-by-step publishing and growth strategy."))))), /*#__PURE__*/React.createElement("section", {
    className: "l-sec tight"
  }, /*#__PURE__*/React.createElement("div", {
    className: "l-banner"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "lb-d"
  }, "Scout is a public API, dashboard, dataset publisher, and MCP-ready intelligence layer.")), /*#__PURE__*/React.createElement("div", {
    className: "lb-pills"
  }, /*#__PURE__*/React.createElement("span", {
    className: "lb-pill"
  }, /*#__PURE__*/React.createElement(LIc, {
    d: L_ICONS.code,
    size: 15
  }), "REST API"), /*#__PURE__*/React.createElement("span", {
    className: "lb-pill"
  }, /*#__PURE__*/React.createElement(LIc, {
    d: L_ICONS.db,
    size: 15
  }), "Open Data"), /*#__PURE__*/React.createElement("span", {
    className: "lb-pill"
  }, /*#__PURE__*/React.createElement(LIc, {
    d: L_ICONS.plug,
    size: 15
  }), "MCP Ready")))), /*#__PURE__*/React.createElement("footer", {
    className: "l-foot"
  }, /*#__PURE__*/React.createElement("div", {
    className: "l-foot-in"
